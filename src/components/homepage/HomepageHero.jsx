        ...
        <div className="max-w-xl">
          ...
          <div className="flex flex-wrap gap-4">
            {/* <NavLink to={Ctr?.link || "/pricing"}>
              <button className="group flex items-center gap-2 px-7 py-3 bg-gradient-to-r from-[#003eb3] via-[#004edb] to-[#0072ff] text-white text-sm rounded-lg shadow-lg hover:shadow-blue-500/20 hover:-translate-y-0.5 transition-all duration-300 active:scale-95 cursor-pointer">
