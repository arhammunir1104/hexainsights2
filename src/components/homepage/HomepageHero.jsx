      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pt-24 pb-16 w-full">
        <div className="max-w-xl">
          ...
          <div className="flex flex-wrap gap-4">
            <NavLink to={Ctr?.link || "/pricing"}>
              <button className="group flex items-center gap-2 px-7 py-3 bg-gradient-to-r from-[#003eb3] via-[#004edb] to-[#0072ff] text-white text-sm font-bold rounded-lg shadow-lg hover:shadow-blue-500/20 hover:-translate-y-0.5 transition-all duration-300 active:scale-95 cursor-pointer">
