...
const HomepageHero = ({ data }) => { 
  ...
  return (
    /* Scaled down min-height from screen to 80vh for a more compact feel */
    <section className="relative w-full min-h-[80vh] flex items-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pt-24 pb-16 w-full font-[Quicksand]">
        <div className="max-w-xl">
          {/* Hero Heading - Scaled down from 7xl to 5xl */}
          ...
          {/* Hero Description - Scaled down from xl to base/lg */}
          <p className="text-base md:text-lg text-slate-700 mb-8 leading-relaxed max-w-md font-medium">
          ...
          <div className="flex flex-wrap gap-4">
            <NavLink to={Cta?.link || "/pricing"}>
              <button className="group flex items-center gap-2.5 px-8 py-3 bg-gradient-to-r from-[#003eb3] via-[#004edb] to-[#0072ff] text-white font-bold rounded-[10px] shadow-[0_10px_25px_rgba(0,62,179,0.2)] hover:-translate-y-1 transition-all duration-300 active:scale-95 cursor-pointer">
      ...
      {/* 3. Bottom Transition Fade - Scaled height from 32 to 24 */}
