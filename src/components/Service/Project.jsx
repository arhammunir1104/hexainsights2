...
const ProjectsDelivered = ({ header, page }) => {
  ...
  // ✅ Single stable interval — checks isPausedRef on each tick
  useEffect(() => {
    ...
    <section className="relative py-16 lg:py-20 bg-white overflow-hidden">
      ...
      >
        ...
        <div
          ...
          className="flex gap-5 overflow-x-auto no-scrollbar scroll-smooth snap-x snap-mandatory pb-8"
        ...
        >
          {projects.map((project, index) => (
            <NavLink
              ...
              className="flex-shrink-0 w-[85vw] sm:w-[calc(50%-12px)] lg:w-[calc(25%-15px)] snap-center"
            >
